...
<body>
<nav class="navbar navbar-inverse animated bounceInRight" style="border-radius: 0px;">
            ...
            <ul class="nav navbar-nav navbar-right">
                ...
                <li class="dropdown">
                    ...
                    <ul class="dropdown-menu">
                        <li><a href="?s=admin/entry/changePassword">修改密码</a></li>
                        <li><a href="?s=admin/login/del">退出登录</a></li>
                    </ul>
                </li>
            </ul>
        </div><!-- /.navbar-collapse -->
